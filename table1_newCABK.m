...
for problem = 1:problem_count
    ...
    CABk5 = CABKAgent(5);
    CABk6 = CABKAgent(6);
    agents = {FIBA, FP, CABk1, CABk2, CABk3, CABk4, CABk5, CABk6, DisAvr1, DisAvr2, DisAvr3, DisAvr4, DisAvr5, DisAvr6};
    ...
    for i = 1:trial_count
        ...
        action_FP = agents{2}.chooseAction();
        ...
        for j = 3:8
            agent = agents{j};
            action = agent.chooseAction_(previous_action);
